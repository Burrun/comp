...
%token DOTDOTDOT BARBAR AMPAMP EQL NEQ LSS GTR LEQ GEQ SLASH PERCENT AMP EXCL MINUS PLUS SIZEOF_SYM LP LR LB RP RR RB PERIOD ARROW PLUSPLUS MINUSMINUS INTEGER_CONSTANT FLOAT_CONSTANT CHARACTER_CONSTANT
%token STRING_LITERAL RETURN_SYM CONTINUE_SYM BREAK_SYM WHILE_SYM DO_SYM FOR_SYM IF_SYM ELSE_SYM SWITCH_SYM DEFAULT_SYM CASE_SYM COLON IDENTIFIER TYPE_IDENTIFIER SEMICOLON  AUTO_SYM STATIC_SYM
%token TYPEDEF_SYM STRUCT_SYM UNION_SYM ENUM_SYM STAR
...
direct_abstract_declarator 
						...
						| direct_abstract_declarator LR constant_expression_opt RR
...
compound_statement
						...
						statement_list_opt RR {checkForwardReference(); $$=makeNode(N_STMT_COMPOUND,$3,NIL,$4);
						current_id=$2; current_level--;}
						;
